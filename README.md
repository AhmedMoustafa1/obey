...
| Id | What it is |
| --- | --- |
| `EggHacks` | **Seven Egg Hacks** — full edit of 8 clips (`public/clips/`): intro + 7 recipe segments, crossfades, animated recipe title cards, word-pop captions, instrumental music bed with automatic dialogue ducking (1080×1920 @ 24fps) |
